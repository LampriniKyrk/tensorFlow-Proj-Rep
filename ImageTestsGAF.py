...
datafiles = ['data/fridge1']  # Data fine name
...
for datafile, train in zip(datafiles, trains):
    ...
    for s in size:
        ...
        labelLines = open('data/fridge1').readlines()
        ...
        for each, labelline in zip(raw, labelLines):
            ...
            if (i >=46000 and i <47000):
                gengrampdfs(image, paaimage, label, str(i))
            i += 1
